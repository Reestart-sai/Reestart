...
const AllPrivateJobs = () => {
  ...
  const privateJobs = jobsData.filter((job) => job.category?.toLowerCase() === 'private job');
  const sortedJobs = sortJobsByDate(privateJobs);
  ...
  return (
    <div className="all-private-jobs-section">
      <h2>All Private Jobs</h2>
